...
namespace Veilborne.Core
{
    ...
    public class WorldConfigService : IWorldConfigService
    {
        ...
        public WorldConfigService(WorldConfig config)
        {
            Config = config;
            Initialize();
        }
        ...
        private void Initialize()
        {
            ...
            if (Config.Dig == null)
                throw new InvalidOperationException("WorldConfig is missing required 'Dig' section.");
            if (Config.Noise == null)
                throw new InvalidOperationException("WorldConfig is missing required 'Noise' section.");
            if (Config.BiomeProvider == null)
                throw new InvalidOperationException("WorldConfig is missing required 'BiomeProvider' section.");
